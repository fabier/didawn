...
class Album {
    ...
    public Album(String id, String md5, String name, ArtistList artists, int mediaVersion, String albumPicture) {
        this(id, md5, name, artists, "", 0L, 0L, "", mediaVersion, albumPicture)
    }

    public Album(String id, String md5, int mediaVersion, String albumPicture) {
        this(id, md5, "", new ArtistList(), "", 0L, 0L, "", mediaVersion, albumPicture)
    }

    public Album(String id, String md5, String name, ArtistList artists, String album, long duration, long trackNum, String year, int mediaVersion, String albumPicture) {
        this.id = id
        this.md5 = md5
        this.name = name.trim()
